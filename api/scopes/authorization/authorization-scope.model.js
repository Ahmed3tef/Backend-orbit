...
const authorizationScopeSchema = new Schema(
  {
    projectId: {
    ...
    data: [{
      id: {
        type: Schema.Types.ObjectId,
        ref: 'AuthorizationOptions',
        required: true,
      }, // id of the authorization option
      fees: {
        type: Number,
        required: true,
      },
...
export const authorizationScopeModel = model('AuthorizationScope', authorizationScopeSchema);
